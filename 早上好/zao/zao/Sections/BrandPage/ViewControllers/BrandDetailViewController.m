...
#import "timeView.h"
#import "GiFHUD.h"
@interface BrandDetailViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,netWorkRequsetDelegate,UIWebViewDelegate>
@property (nonatomic,retain)NSMutableArray *dataArray;
@property (nonatomic,retain)UICollectionView *collectionView;
@property (nonatomic,retain)UIButton *backButton;
@property (nonatomic,retain)BrandDetailView *upperView;
@property (nonatomic,assign)NSInteger newNumber;
...
- (void)conllectionViewReload:(id)data{
    ...
    //NSLog(@"个数：%lu",(unsigned long)dataArr.count);
    [self.collectionView reloadData];
}
...
- (void)addHeader{
    BrandDetailViewController *weakSelf = self;
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    //self.timeView.model = self.brandModel;
}
