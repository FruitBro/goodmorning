...
#import "foreshowGoodsViewController.h"
#import "timeView.h"
#import "refreshView.h"
#import "MJRefresh.h"
@interface ForeshowListViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,netWorkRequsetDelegate>
...
@implementation ForeshowListViewController
- (void)dealloc{
    [_brandModel release];
...
- (void)requestURLData{
    ...
    NSString *completedURLStr = [NSString stringWithFormat:@"http://m.api.zhe800.com/v6/brand/getdealsbyid?per_page=20&image_model=webp&order=saled&begin_time=1439514000&brand_id=%@&page=1&new=1",self.brandModel._id];
    
    [NetWorkRequset getNetRequset:completedURLStr];
}

- (void)addHeader{
    ForeshowListViewController *weakSelf = self;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    foreshowGoodsViewController *goodsVC = [[foreshowGoodsViewController alloc]init];
    brandDetailListModel *model = [self.dataArray objectAtIndex:indexPath.row];
    goodsVC.model = model;
