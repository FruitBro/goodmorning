...
@interface WebpageLodController ()<netWorkRequsetDelegate,UIWebViewDelegate>
...
@implementation WebpageLodController
- (void)dealloc{
    [_model release];
...
- (void)viewDidLoad {
    ...
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:self.model.wap_url]]];
