//
//  ClassifyWebpageViewController.m
...
#import "SizeMacros.h"
@interface ClassifyWebpageViewController ()<netWorkRequsetDelegate,UIWebViewDelegate>
...
@implementation ClassifyWebpageViewController
- (void)dealloc{
    [_model release];
    [_web release];
