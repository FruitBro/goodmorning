...
@interface ClickWebBrandViewController ()<UIWebViewDelegate,netWorkRequsetDelegate>
...
@implementation ClickWebBrandViewController
- (void)dealloc{
    [_web release];
...
- (void)detailWithHTMLInWebView{
    //
    NSURLRequest *urlReauest = [NSURLRequest requestWithURL:[NSURL URLWithString:self.model.wap_url]];
    //创建UIWebView;
...
- (void)webViewDidStartLoad:(UIWebView *)webView{
    ...
    self.activLabel = [[UILabel alloc] initWithFrame:CGRectMake(137, 320, 100, 30)];
    ...
    [self.activityView setCenter:CGPointMake(187, 300)];
