...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"今天很划算";
...
- (void)detailWithHTMLInWebView{
    //
    NSURLRequest *urlReauest = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://jkjby.yijia.com/jkjby/view/nine_web/index.php?app_id=3119872284&sche=fen_nine_anzhong&app_channel=Android"]];
    //创建UIWebView;
