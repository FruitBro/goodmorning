...
#import "SizeMacros.h"
@interface LookwebViewController ()<UIWebViewDelegate>
...
@implementation LookwebViewController
- (void)dealloc{
    [_web release];
...
- (void)detailWithHTMLInWebView{
    //
    NSURLRequest *urlReauest = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://zhekou.repai.com/lws/view/zhe_miaoyiyan.php?app_id=3119872284&sche=fen_nine_anzhong&app_channel=Android"]];
    //创建UIWebView;
